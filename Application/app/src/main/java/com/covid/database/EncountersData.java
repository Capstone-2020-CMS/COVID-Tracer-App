...
public class EncountersData {
    ...
    public static void recordEncountersData(String EncounterID,String EncounterDate, String EncounterTime) {
        ...
        MainActivity.encounterDB.insertEncounterData(EncounterID, EncounterDate, EncounterTime);
